...
We are therefore assuming that short-range interactions occur for individuals located within 40 cm of one another.
...
We discourage the use of `ppjsdm` direct for a few reasons though.
...
We see here that this data is significantly more clustered than a Poisson point process for distances of less than 0.4 m, with another small detected clustering around 0.6 m.
...
We optimize by minimising the AIC over the short range for 4 potentials.
