...
```{r}
number_of_species <- 7
bci <- get_bci(least_prevalent = 50, most_prevalent = 50 + number_of_species)
...
```{r}
short_range <- matrix(3, number_of_species, number_of_species)
medium_range <- matrix(3, number_of_species, number_of_species)
long_range <- matrix(10, number_of_species, number_of_species)
```
