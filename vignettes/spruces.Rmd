...
```{r}
truncated_spruces <- spruces
# Window(truncated_spruces) <-  owin(c(3, 56), c(0, 35))
configuration <- Configuration(truncated_spruces$x, truncated_spruces$y, marks = truncated_spruces$marks)
